...
def index():
    ...
    embed = DiscordEmbed(url=WEBHOOK_URL, title='Switch', description = "Screenshots from Rocket's Switch", color='03b2f8')
    embed.set_author(name='Nintendo Switch', url='https://nintendo.com', icon_url=ICON_URL)
